...
const ar = {
  ...
  // المرحلة الأولى — بوابة التحقق من البريد الإلكتروني
  verifyEmail: {
    title:          'تحقق من بريدك الإلكتروني',
    subtitle:       'لقد أرسلنا رابط تأكيد إلى صندوق بريدك.',
    instruction:    'انقر على الرابط في البريد الإلكتروني لتفعيل حسابك. إذا لم تجده، تحقق من مجلد البريد المزعج.',
    resendBtn:      'إعادة إرسال بريد التحقق',
    resendCooldown: (s) => `إعادة الإرسال خلال ${s} ثانية`,
    resendSuccess:  'تم إرسال بريد تحقق جديد بنجاح!',
    resendError:    'فشل إعادة الإرسال. يرجى المحاولة مرة أخرى.',
    logoutBtn:      'تسجيل الخروج',
    checkEmail:     'تحقق من صندوق الوارد',
    noEmail:        'لم تستلم البريد الإلكتروني؟',
  },

  // المرحلة الثانية — بوابة التحقق من الهوية
  verifyIdentity: {
    title:       'التحقق من الهوية',
    subtitle:    'خطوة أخيرة قبل الوصول إلى المنصة كاملاً.',
    instruction: 'ارفع صورة واضحة من الأمام والخلف لهويتك الوطنية. سيراجع فريقنا البيانات ويفعّل حسابك.',
    pending:     'طلب التحقق قيد المراجعة. سنخطرك فور الموافقة.',
