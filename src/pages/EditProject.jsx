...
export default function EditProject() {
  ...
  if (error && !form.title) return <div className="p-8 text-red-600">{error}</div>
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              ...
              <p className="text-sm text-gray-600 mt-2">Confirm changes to your project timeline and ownership settings before saving.</p>
            </div>
          </div>
        )}
