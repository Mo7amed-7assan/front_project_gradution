    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {items.length === 0 ? (
        <div className="card text-center py-16 border-2 border-dashed border-slate-200">
          ...
          <h3 className="font-bold text-slate-800 text-lg mb-1">No action logs found</h3>
          <p className="text-slate-500 text-sm">No admin actions match the selected filter.</p>
        </div>
      ) : (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {(log.description || log.reason) && (
                        <p className="text-xs text-slate-500 mt-1 truncate">{log.description || log.reason}</p>
                      )}
                    </div>
                    <div className="text-right text-xs text-slate-400 shrink-0 font-medium">
