             ...
             <div className="p-6 md:p-8">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div>
                   ...
                   <div className={`relative rounded-2xl overflow-hidden border-2 border-dashed ${images.front ? 'border-emerald-300 bg-emerald-50/30' : 'border-slate-300 bg-slate-50'} aspect-video flex items-center justify-center group transition-colors`}>
                     {images.front ? (
                       <>
                 ...
                 <div>
                   ...
                   <div className={`relative rounded-2xl overflow-hidden border-2 border-dashed ${images.back ? 'border-emerald-300 bg-emerald-50/30' : 'border-slate-300 bg-slate-50'} aspect-video flex items-center justify-center group transition-colors`}>
                     {images.back ? (
                       <>
